...
(function () {
  ...
  var accordion = function accordion() {
    ...
    var data = $(".accordion").attr("data-accordion"); // start the event Handler
    ...
    $(".accordion-header").on("click", function () {
      ...
      if (data === "close") {
        ...
        if ($(this).hasClass("active-acorddion")) {
          $(this).toggleClass("active-acorddion");
        } else {
          $(".accordion-header").removeClass("active-acorddion");
          $(this).toggleClass("active-acorddion");
        }
      } else {
        $(this).toggleClass("active-acorddion");
  ...
  accordion(); // Carousel Feature Slide
  ...
  var aboutWayPoint = function aboutWayPoint() {
    if ($('#about-us').length > 0) {
  ...
  var teamAnimate = function teamAnimate() {
    if ($('#team').length > 0) {
  ...
  var teamWayPoint = function teamWayPoint() {
    if ($('#team').length > 0) {
  ...
  var servicesWayPoint = function servicesWayPoint() {
    if ($('#fh5co-our-services').length > 0) {
  ...
  var featuresAnimate = function featuresAnimate() {
  ...
  var featuresWayPoint = function featuresWayPoint() {
    if ($('#fh5co-features').length > 0) {
  ...
  var testimonialsAnimate = function testimonialsAnimate() {
  ...
  var testimonialsWayPoint = function testimonialsWayPoint() {
    if ($('#fh5co-testimonials').length > 0) {
  ...
  var pricingAnimate = function pricingAnimate() {
  ...
  var pricingWayPoint = function pricingWayPoint() {
    if ($('#fh5co-pricing').length > 0) {
  ...
  var pressAnimate = function pressAnimate() {
  ...
  var pressWayPoint = function pressWayPoint() {
    if ($('#fh5co-press').length > 0) {
